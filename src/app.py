...
activities = {
    ...
    "Soccer Team": {
        "description": "Weekly soccer practice and matches",
    ...
    "Drama Club": {
        "description": "Acting, scriptwriting, and theater performances",
    ...
    "Math Club": {
        "description": "Solving challenging math problems and participating in math contests",
